<template>
  <div class="exchange-market" v-if="myItem">
    <back-button />
    <div class="wrap-addition">
      ...
      <div class="option-detail">
        ...
        <div v-if="myItem.item.options.length > 0" class="wrap-option">
...
import { createNamespacedHelpers, useActions, useMutations } from 'vuex-composition-helpers/dist';
