      ...
      <div class="section__inner">
        <div class="exchange-list for-list">
          ...
          <div id="wrapFilterList" class="wrap-swiper sticky">
            <swiper v-if="filter.searchType === 1" ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
            ...
            <swiper v-if="filter.searchType === 2" ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
              <swiper-slide key="ex-list-filter-grade">
            ...
            <swiper v-if="filter.searchType === 3" ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
              <swiper-slide key="ex-list-filter-grade">
